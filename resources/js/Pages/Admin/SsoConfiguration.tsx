    ...
    return (
        ...
        >
                ...
                <Box sx={{ flex: 1 }}>
                    ...
                    >
                        <Typography variant="body2" color="text.secondary">
                            Configure SAML2 Single Sign-On providers for
                    ...
                    {configurations.length === 0 ? (
                        ...
                        >
                            <Typography color="text.secondary">
                                No SSO providers configured. Add one to enable
            ...
            <Dialog
                ...
                maxWidth="md"
                fullWidth
                aria-labelledby="sso-provider-dialog-title"
            >
                <DialogTitle id="sso-provider-dialog-title">
                    {editing ? "Edit SSO Provider" : "Add SAML2 Provider"}
                </DialogTitle>
                <DialogContent>
                    <Box
                        sx={{
                    ...
                    >
                        ...
                        <TextField
                            ...
                            onChange={(e) =>
                                form.setData("login_url", e.target.value)
                            }
                        ...
                        <TextField
                            ...
                            onChange={(e) =>
                                form.setData("logout_url", e.target.value)
                            }
                        ...
                        <TextField
                            label={
                                editing
                                    ? "IdP Certificate (leave blank to keep current)"
                                    : "IdP Certificate"
                            }
                            value={form.data.certificate}
                            onChange={(e) =>
                                form.setData("certificate", e.target.value)
                            }
                        ...
                        <TextField
                            ...
                            onChange={(e) =>
                                form.setData("metadata_url", e.target.value)
                            }
                            error={!!form.errors.metadata_url}
                            helperText={
                                form.errors.metadata_url ||
                                "Optional IdP metadata URL"
                            }
                            fullWidth
                        />
                        ...
                        <TextField
                            ...
                            onChange={(e) =>
                                form.setData("attribute_mapping", {
                                    ...form.data.attribute_mapping,
            ...
            <Dialog
                ...
                aria-labelledby="delete-sso-dialog-title"
            >
                <DialogTitle id="delete-sso-dialog-title">
                    Delete SSO Provider
                </DialogTitle>
                <DialogContent>
                    <Alert severity="warning" sx={{ mt: 1 }}>
                        This will remove the SSO provider. Users authenticated
                        via this provider will need to reset their password or

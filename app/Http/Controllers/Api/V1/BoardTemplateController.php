...
class BoardTemplateController extends Controller
{
    ...
    /**
     * Snapshot a board's columns into a new reusable board template.
     */
    ...
    /**
     * Create a new board on the team from a board template.
     */
    public function createBoard(Request $request, Team $team, BoardTemplate $boardTemplate): JsonResponse
    {
